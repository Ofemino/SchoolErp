...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form role="form" method="post" action="/admission/post" enctype="multipart/form-data" role="form"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="OtherNames" id="txtOtherNames" class="form-control"
                                                   value="{{old('body')}}" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select required="required" name="Gender" id="ddnGender"
                                                    class="form-control">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input required="required" class="form-control" id="dtDob" name="Dob"
                                                   value="{{old('body')}}" placeholder="DD/MM/YYYY"
                                                   type="text"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input required="required" id="childAvatar" name="childAvatar" type="file"
